...
DriveToWP *initDriveToWP(Drive drive, double distance, int rotation)
{
	...
	/*DriveToWP newStep = {.drive = robotDrive, .magnitudeKP = 8, .turningKP = 6, .straightRotationKP = .5,
